...
> Last updated: 2026-04-19T18:19:52.666Z
>
...
| Llama-3.2-3B-Instruct | `meta-llama/Llama-3.2-3B-Instruct` | ? params | 4.3M |
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| Qwen3-0.6B | `Qwen/Qwen3-0.6B` | ? params | 15.9M |
...
---
*Last updated: 2026-04-19 | Open models auto-fetched from HuggingFace*
