...
> Last updated: 2026-04-22T07:39:56.727Z
>
...
| Llama-3.2-1B-Instruct | `meta-llama/Llama-3.2-1B-Instruct` | ? params | 4.9M |
| Llama-3.2-3B-Instruct | `meta-llama/Llama-3.2-3B-Instruct` | ? params | 3.7M |
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| DeepSeek-V3.2 | `deepseek-ai/DeepSeek-V3.2` | ? params | 10.7M |
...
| DeepSeek-V3 | `deepseek-ai/DeepSeek-V3` | ? params | 0.9M |
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| Qwen3-0.6B | `Qwen/Qwen3-0.6B` | ? params | 16.9M |
| Qwen2.5-7B-Instruct | `Qwen/Qwen2.5-7B-Instruct` | ? params | 12.4M |
| Qwen2.5-1.5B-Instruct | `Qwen/Qwen2.5-1.5B-Instruct` | ? params | 10.6M |
| Qwen2.5-3B-Instruct | `Qwen/Qwen2.5-3B-Instruct` | ? params | 10.1M |
| Qwen3-4B-Instruct-2507 | `Qwen/Qwen3-4B-Instruct-2507` | ? params | 10.1M |
| Qwen3-8B | `Qwen/Qwen3-8B` | ? params | 8.9M |
| Qwen3-4B | `Qwen/Qwen3-4B` | ? params | 7.2M |
| Qwen3-1.7B | `Qwen/Qwen3-1.7B` | ? params | 6.9M |
...
| Mistral-7B-v0.1 | `mistralai/Mistral-7B-v0.1` | ? params | 0.9M |
...
| gemma-2b | `google/gemma-2b` | ? params | 0.1M |
...
| Phi-4-mini-instruct | `microsoft/Phi-4-mini-instruct` | ? params | 1.4M |
| phi-2 | `microsoft/phi-2` | ? params | 0.8M |
...
| Gemma-4-31B-IT-NVFP4 | `nvidia/Gemma-4-31B-IT-NVFP4` | ? params | 1.4M |
| NVIDIA-Nemotron-3-Super-120B-A12B-NVFP4 | `nvidia/NVIDIA-Nemotron-3-Super-120B-A12B-NVFP4` | ? params | 1.2M |
| Kimi-K2.5-NVFP4 | `nvidia/Kimi-K2.5-NVFP4` | ? params | 1.1M |
...
---
*Last updated: 2026-04-22 | Open models auto-fetched from HuggingFace*
