...
> Last updated: 2026-04-30T17:36:01.343Z
>
...
| Llama-3.2-1B-Instruct | `meta-llama/Llama-3.2-1B-Instruct` | ? params | 5.9M |
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| DeepSeek-V3.2 | `deepseek-ai/DeepSeek-V3.2` | ? params | 11.6M |
| DeepSeek-R1 | `deepseek-ai/DeepSeek-R1` | ? params | 4.1M |
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| Qwen3-0.6B | `Qwen/Qwen3-0.6B` | ? params | 19.8M |
| Qwen2.5-7B-Instruct | `Qwen/Qwen2.5-7B-Instruct` | ? params | 13.4M |
| Qwen2.5-1.5B-Instruct | `Qwen/Qwen2.5-1.5B-Instruct` | ? params | 10.1M |
| Qwen3-4B-Instruct-2507 | `Qwen/Qwen3-4B-Instruct-2507` | ? params | 10.0M |
| Qwen3-8B | `Qwen/Qwen3-8B` | ? params | 9.7M |
| Qwen2.5-3B-Instruct | `Qwen/Qwen2.5-3B-Instruct` | ? params | 9.3M |
| Qwen2.5-0.5B-Instruct | `Qwen/Qwen2.5-0.5B-Instruct` | ? params | 6.4M |
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| Gemma-4-31B-IT-NVFP4 | `nvidia/Gemma-4-31B-IT-NVFP4` | ? params | 2.0M |
...
| DeepSeek-R1-0528-NVFP4-v2 | `nvidia/DeepSeek-R1-0528-NVFP4-v2` | ? params | 1.3M |
...
| gpt-oss-120b | `openai/gpt-oss-120b` | ? params | 4.0M |
