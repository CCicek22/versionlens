...
> Last updated: 2026-04-25T19:22:01.999Z
>
...
|-------|----------------|------|-----------|
| Llama-3.1-8B-Instruct | `meta-llama/Llama-3.1-8B-Instruct` | ? params | 9.2M |
| Llama-3.2-1B-Instruct | `meta-llama/Llama-3.2-1B-Instruct` | ? params | 5.2M |
| Meta-Llama-3-8B | `meta-llama/Meta-Llama-3-8B` | ? params | 3.3M |
| Llama-3.2-3B-Instruct | `meta-llama/Llama-3.2-3B-Instruct` | ? params | 2.9M |
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| DeepSeek-V3.2 | `deepseek-ai/DeepSeek-V3.2` | ? params | 11.0M |
...
| DeepSeek-V2-Lite-Chat | `deepseek-ai/DeepSeek-V2-Lite-Chat` | ? params | 0.9M |

### Qwen (Alibaba)

| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| Qwen3-0.6B | `Qwen/Qwen3-0.6B` | ? params | 18.1M |
| Qwen2.5-7B-Instruct | `Qwen/Qwen2.5-7B-Instruct` | ? params | 12.2M |
| Qwen2.5-1.5B-Instruct | `Qwen/Qwen2.5-1.5B-Instruct` | ? params | 10.0M |
| Qwen3-4B-Instruct-2507 | `Qwen/Qwen3-4B-Instruct-2507` | ? params | 9.8M |
| Qwen2.5-3B-Instruct | `Qwen/Qwen2.5-3B-Instruct` | ? params | 9.2M |
| Qwen3-8B | `Qwen/Qwen3-8B` | ? params | 8.8M |
| Qwen3-4B | `Qwen/Qwen3-4B` | ? params | 6.6M |
| Qwen3-1.7B | `Qwen/Qwen3-1.7B` | ? params | 6.5M |

### Mistral

| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| Mistral-7B-Instruct-v0.2 | `mistralai/Mistral-7B-Instruct-v0.2` | ? params | 2.0M |
...
| gemma-2-2b | `google/gemma-2-2b` | ? params | 0.4M |
...
| phi-2 | `microsoft/phi-2` | ? params | 0.7M |
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| Gemma-4-31B-IT-NVFP4 | `nvidia/Gemma-4-31B-IT-NVFP4` | ? params | 1.7M |
...
| NVIDIA-Nemotron-3-Super-120B-A12B-NVFP4 | `nvidia/NVIDIA-Nemotron-3-Super-120B-A12B-NVFP4` | ? params | 1.0M |

### OpenAI (Open-weight)

| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| gpt-oss-20b | `openai/gpt-oss-20b` | ? params | 6.6M |
...
---
*Last updated: 2026-04-25 | Open models auto-fetched from HuggingFace*
