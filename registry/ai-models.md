...
> Last updated: 2026-04-06T10:30:47.145Z
>
...
| Llama-3.2-1B-Instruct | `meta-llama/Llama-3.2-1B-Instruct` | ? params | 4.1M |
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| DeepSeek-R1 | `deepseek-ai/DeepSeek-R1` | ? params | 2.8M |
| DeepSeek-R1-Distill-Llama-8B | `deepseek-ai/DeepSeek-R1-Distill-Llama-8B` | ? params | 1.0M |
| DeepSeek-V3.2 | `deepseek-ai/DeepSeek-V3.2` | ? params | 1.0M |
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| Qwen3-0.6B | `Qwen/Qwen3-0.6B` | ? params | 14.2M |
| Qwen2.5-7B-Instruct | `Qwen/Qwen2.5-7B-Instruct` | ? params | 13.1M |
...
| Qwen2.5-3B-Instruct | `Qwen/Qwen2.5-3B-Instruct` | ? params | 8.0M |
| Qwen3-1.7B | `Qwen/Qwen3-1.7B` | ? params | 7.7M |
| Qwen3-4B-Instruct-2507 | `Qwen/Qwen3-4B-Instruct-2507` | ? params | 7.0M |
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| NVIDIA-Nemotron-3-Super-120B-A12B-NVFP4 | `nvidia/NVIDIA-Nemotron-3-Super-120B-A12B-NVFP4` | ? params | 1.6M |
...
| gpt-oss-120b | `openai/gpt-oss-120b` | ? params | 3.8M |
...
---
*Last updated: 2026-04-06 | Open models auto-fetched from HuggingFace*
