...
> Last updated: 2026-05-03T06:59:46.102Z
>
...
| Llama-2-7b-hf | `meta-llama/Llama-2-7b-hf` | ? params | 1.8M |
...
| DeepSeek-R1-0528 | `deepseek-ai/DeepSeek-R1-0528` | ? params | 1.1M |
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| Qwen3-0.6B | `Qwen/Qwen3-0.6B` | ? params | 19.9M |
| Qwen2.5-7B-Instruct | `Qwen/Qwen2.5-7B-Instruct` | ? params | 13.7M |
| Qwen3-4B-Instruct-2507 | `Qwen/Qwen3-4B-Instruct-2507` | ? params | 10.3M |
| Qwen3-8B | `Qwen/Qwen3-8B` | ? params | 9.9M |
| Qwen2.5-1.5B-Instruct | `Qwen/Qwen2.5-1.5B-Instruct` | ? params | 9.6M |
| Qwen2.5-3B-Instruct | `Qwen/Qwen2.5-3B-Instruct` | ? params | 9.4M |
| Qwen2.5-0.5B-Instruct | `Qwen/Qwen2.5-0.5B-Instruct` | ? params | 6.2M |
