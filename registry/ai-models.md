...
> Last updated: 2026-04-27T17:35:21.301Z
>
...
| Llama-3.2-3B-Instruct | `meta-llama/Llama-3.2-3B-Instruct` | ? params | 2.2M |
...
| DeepSeek-Coder-V2-Lite-Instruct | `deepseek-ai/DeepSeek-Coder-V2-Lite-Instruct` | ? params | 0.9M |

### Qwen (Alibaba)

| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| Qwen3-0.6B | `Qwen/Qwen3-0.6B` | ? params | 18.3M |
...
| Qwen3-1.7B | `Qwen/Qwen3-1.7B` | ? params | 6.2M |
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| Gemma-4-31B-IT-NVFP4 | `nvidia/Gemma-4-31B-IT-NVFP4` | ? params | 1.8M |
...
---
*Last updated: 2026-04-27 | Open models auto-fetched from HuggingFace*
