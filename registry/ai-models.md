...
> Last updated: 2026-05-02T00:53:53.018Z
>
...
|-------|----------------|------|-----------|
| Llama-3.1-8B-Instruct | `meta-llama/Llama-3.1-8B-Instruct` | ? params | 9.8M |
| Llama-3.2-1B-Instruct | `meta-llama/Llama-3.2-1B-Instruct` | ? params | 6.0M |
| Meta-Llama-3-8B | `meta-llama/Meta-Llama-3-8B` | ? params | 3.5M |
| Llama-3.2-3B-Instruct | `meta-llama/Llama-3.2-3B-Instruct` | ? params | 2.0M |
| Llama-2-7b-hf | `meta-llama/Llama-2-7b-hf` | ? params | 1.9M |
| Meta-Llama-3-8B-Instruct | `meta-llama/Meta-Llama-3-8B-Instruct` | ? params | 1.6M |
| Llama-3.1-8B | `meta-llama/Llama-3.1-8B` | ? params | 1.6M |
| Llama-3.2-1B | `meta-llama/Llama-3.2-1B` | ? params | 1.5M |

### DeepSeek

| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| DeepSeek-V3.2 | `deepseek-ai/DeepSeek-V3.2` | ? params | 11.2M |
...
| DeepSeek-Coder-V2-Lite-Instruct | `deepseek-ai/DeepSeek-Coder-V2-Lite-Instruct` | ? params | 1.1M |

### Qwen (Alibaba)

| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| Qwen3-0.6B | `Qwen/Qwen3-0.6B` | ? params | 20.0M |
| Qwen2.5-7B-Instruct | `Qwen/Qwen2.5-7B-Instruct` | ? params | 13.6M |
| Qwen3-4B-Instruct-2507 | `Qwen/Qwen3-4B-Instruct-2507` | ? params | 10.1M |
| Qwen3-8B | `Qwen/Qwen3-8B` | ? params | 9.9M |
| Qwen2.5-1.5B-Instruct | `Qwen/Qwen2.5-1.5B-Instruct` | ? params | 9.8M |
| Qwen2.5-3B-Instruct | `Qwen/Qwen2.5-3B-Instruct` | ? params | 9.5M |
| Qwen2.5-0.5B-Instruct | `Qwen/Qwen2.5-0.5B-Instruct` | ? params | 6.3M |
| Qwen3-Embedding-0.6B | `Qwen/Qwen3-Embedding-0.6B` | ? params | 5.9M |

### Mistral

| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| Mistral-7B-Instruct-v0.2 | `mistralai/Mistral-7B-Instruct-v0.2` | ? params | 2.2M |
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| Phi-3.5-vision-instruct | `microsoft/Phi-3.5-vision-instruct` | ? params | 1.7M |
| Phi-4-mini-instruct | `microsoft/Phi-4-mini-instruct` | ? params | 1.6M |
...
| phi-4 | `microsoft/phi-4` | ? params | 0.6M |

### NVIDIA

| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| Gemma-4-31B-IT-NVFP4 | `nvidia/Gemma-4-31B-IT-NVFP4` | ? params | 2.1M |
| NVIDIA-Nemotron-3-Nano-30B-A3B-BF16 | `nvidia/NVIDIA-Nemotron-3-Nano-30B-A3B-BF16` | ? params | 1.4M |
| DeepSeek-R1-0528-NVFP4-v2 | `nvidia/DeepSeek-R1-0528-NVFP4-v2` | ? params | 1.4M |
| Kimi-K2.5-NVFP4 | `nvidia/Kimi-K2.5-NVFP4` | ? params | 1.4M |

### OpenAI (Open-weight)

| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| gpt-oss-20b | `openai/gpt-oss-20b` | ? params | 6.9M |
| gpt-oss-120b | `openai/gpt-oss-120b` | ? params | 4.1M |
...
---
*Last updated: 2026-05-02 | Open models auto-fetched from HuggingFace*
