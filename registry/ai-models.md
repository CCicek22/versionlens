...
> Last updated: 2026-04-13T17:29:10.640Z
>
...
| Llama-3.2-3B-Instruct | `meta-llama/Llama-3.2-3B-Instruct` | ? params | 5.4M |
...
| Llama-3.2-1B | `meta-llama/Llama-3.2-1B` | ? params | 1.2M |

### DeepSeek

| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| DeepSeek-V3.2 | `deepseek-ai/DeepSeek-V3.2` | ? params | 6.4M |
...
| Qwen3-8B | `Qwen/Qwen3-8B` | ? params | 8.1M |
| Qwen3-4B | `Qwen/Qwen3-4B` | ? params | 8.0M |
| Qwen3-1.7B | `Qwen/Qwen3-1.7B` | ? params | 7.9M |
| Qwen3-4B-Instruct-2507 | `Qwen/Qwen3-4B-Instruct-2507` | ? params | 7.3M |
...
| Mistral-7B-v0.1 | `mistralai/Mistral-7B-v0.1` | ? params | 0.8M |
...
| phi-2 | `microsoft/phi-2` | ? params | 1.2M |
...
| NVIDIA-Nemotron-3-Nano-30B-A3B-FP8 | `nvidia/NVIDIA-Nemotron-3-Nano-30B-A3B-FP8` | ? params | 0.9M |
