...
> Last updated: 2026-04-21T13:39:43.822Z
>
...
| Llama-3.2-1B-Instruct | `meta-llama/Llama-3.2-1B-Instruct` | ? params | 4.8M |
| Llama-3.2-3B-Instruct | `meta-llama/Llama-3.2-3B-Instruct` | ? params | 3.9M |
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| DeepSeek-V3.2 | `deepseek-ai/DeepSeek-V3.2` | ? params | 10.6M |
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| Qwen3-0.6B | `Qwen/Qwen3-0.6B` | ? params | 16.4M |
...
| Qwen3-4B | `Qwen/Qwen3-4B` | ? params | 7.3M |
...
| gemma-3-270m-it | `google/gemma-3-270m-it` | ? params | 0.1M |
...
| Phi-4-mini-instruct | `microsoft/Phi-4-mini-instruct` | ? params | 1.3M |
| phi-2 | `microsoft/phi-2` | ? params | 0.9M |
...
---
*Last updated: 2026-04-21 | Open models auto-fetched from HuggingFace*
