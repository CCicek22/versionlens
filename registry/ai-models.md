...
> Last updated: 2026-04-16T07:39:44.701Z
>
...
| Llama-3.2-3B-Instruct | `meta-llama/Llama-3.2-3B-Instruct` | ? params | 5.0M |
| Llama-3.2-1B-Instruct | `meta-llama/Llama-3.2-1B-Instruct` | ? params | 4.4M |
...
| Qwen3-4B | `Qwen/Qwen3-4B` | ? params | 7.8M |
| Qwen3-1.7B | `Qwen/Qwen3-1.7B` | ? params | 7.6M |
...
| gemma-2-2b | `google/gemma-2-2b` | ? params | 0.6M |
...
| gemma-7b | `google/gemma-7b` | ? params | 0.1M |
...
| Phi-4-mini-instruct | `microsoft/Phi-4-mini-instruct` | ? params | 1.2M |
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| gpt-oss-20b | `openai/gpt-oss-20b` | ? params | 6.2M |
