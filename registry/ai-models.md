...
> Last updated: 2026-04-13T01:41:18.995Z
>
...
| Llama-3.2-3B-Instruct | `meta-llama/Llama-3.2-3B-Instruct` | ? params | 5.3M |
...
| DeepSeek-V3.2 | `deepseek-ai/DeepSeek-V3.2` | ? params | 2.8M |
...
| Qwen2.5-3B-Instruct | `Qwen/Qwen2.5-3B-Instruct` | ? params | 8.8M |
| Qwen3-8B | `Qwen/Qwen3-8B` | ? params | 8.2M |
| Qwen3-4B | `Qwen/Qwen3-4B` | ? params | 8.1M |
| Qwen3-1.7B | `Qwen/Qwen3-1.7B` | ? params | 8.1M |
| Qwen3-4B-Instruct-2507 | `Qwen/Qwen3-4B-Instruct-2507` | ? params | 7.2M |
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| gemma-3-1b-it | `google/gemma-3-1b-it` | ? params | 0.8M |
...
| Phi-4-mini-instruct | `microsoft/Phi-4-mini-instruct` | ? params | 1.1M |
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| gpt-oss-20b | `openai/gpt-oss-20b` | ? params | 6.0M |
| gpt-oss-120b | `openai/gpt-oss-120b` | ? params | 3.4M |
...
---
*Last updated: 2026-04-13 | Open models auto-fetched from HuggingFace*
