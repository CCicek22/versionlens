...
> Last updated: 2026-04-05T08:18:27.201Z
>
...
| Llama-3.2-1B | `meta-llama/Llama-3.2-1B` | ? params | 1.7M |
...
| Qwen2.5-7B-Instruct | `Qwen/Qwen2.5-7B-Instruct` | ? params | 13.5M |
...
| Qwen3-1.7B | `Qwen/Qwen3-1.7B` | ? params | 7.5M |
| Qwen3-4B-Instruct-2507 | `Qwen/Qwen3-4B-Instruct-2507` | ? params | 6.9M |
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| gemma-3-1b-it | `google/gemma-3-1b-it` | ? params | 1.2M |
| gemma-2-2b | `google/gemma-2-2b` | ? params | 0.5M |
| gemma-2-2b-it | `google/gemma-2-2b-it` | ? params | 0.4M |
| gemma-2-27b-it | `google/gemma-2-27b-it` | ? params | 0.3M |
...
| Phi-4-mini-instruct | `microsoft/Phi-4-mini-instruct` | ? params | 0.8M |
...
---
*Last updated: 2026-04-05 | Open models auto-fetched from HuggingFace*
