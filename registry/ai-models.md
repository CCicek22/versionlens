...
> Last updated: 2026-05-15T07:18:20.515Z
>
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| DeepSeek-V3.2 | `deepseek-ai/DeepSeek-V3.2` | ? params | 4.1M |
| DeepSeek-R1 | `deepseek-ai/DeepSeek-R1` | ? params | 3.8M |
| DeepSeek-V4-Pro | `deepseek-ai/DeepSeek-V4-Pro` | ? params | 2.6M |
| DeepSeek-R1-0528 | `deepseek-ai/DeepSeek-R1-0528` | ? params | 1.9M |
| DeepSeek-V4-Flash | `deepseek-ai/DeepSeek-V4-Flash` | ? params | 1.5M |
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| Qwen3-0.6B | `Qwen/Qwen3-0.6B` | ? params | 19.0M |
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| gemma-3-270m | `google/gemma-3-270m` | ? params | 1.6M |
