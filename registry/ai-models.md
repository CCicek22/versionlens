...
> Last updated: 2026-05-10T05:19:06.389Z
>
...
| Llama-3.2-1B-Instruct | `meta-llama/Llama-3.2-1B-Instruct` | ? params | 6.9M |
...
| Llama-2-7b-hf | `meta-llama/Llama-2-7b-hf` | ? params | 1.3M |
...
| DeepSeek-R1-0528 | `deepseek-ai/DeepSeek-R1-0528` | ? params | 1.6M |
| DeepSeek-V3 | `deepseek-ai/DeepSeek-V3` | ? params | 1.2M |
| DeepSeek-V4-Pro | `deepseek-ai/DeepSeek-V4-Pro` | ? params | 1.2M |
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| Qwen3-0.6B | `Qwen/Qwen3-0.6B` | ? params | 18.6M |
| Qwen2.5-7B-Instruct | `Qwen/Qwen2.5-7B-Instruct` | ? params | 14.4M |
| Qwen2.5-1.5B-Instruct | `Qwen/Qwen2.5-1.5B-Instruct` | ? params | 11.8M |
| Qwen3-8B | `Qwen/Qwen3-8B` | ? params | 11.1M |
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| Mistral-7B-Instruct-v0.2 | `mistralai/Mistral-7B-Instruct-v0.2` | ? params | 3.0M |
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| gemma-3-270m | `google/gemma-3-270m` | ? params | 0.7M |
...
---
*Last updated: 2026-05-10 | Open models auto-fetched from HuggingFace*
