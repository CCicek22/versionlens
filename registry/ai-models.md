...
> Last updated: 2026-04-15T12:31:53.931Z
>
...
| Llama-3.2-3B-Instruct | `meta-llama/Llama-3.2-3B-Instruct` | ? params | 5.2M |
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| DeepSeek-V3.2 | `deepseek-ai/DeepSeek-V3.2` | ? params | 10.0M |
...
| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| Qwen3-0.6B | `Qwen/Qwen3-0.6B` | ? params | 15.0M |
| Qwen2.5-7B-Instruct | `Qwen/Qwen2.5-7B-Instruct` | ? params | 12.7M |
| Qwen2.5-1.5B-Instruct | `Qwen/Qwen2.5-1.5B-Instruct` | ? params | 10.2M |
| Qwen2.5-3B-Instruct | `Qwen/Qwen2.5-3B-Instruct` | ? params | 10.0M |
| Qwen3-8B | `Qwen/Qwen3-8B` | ? params | 8.3M |
| Qwen3-4B | `Qwen/Qwen3-4B` | ? params | 7.9M |
...
| gemma-2-27b-it | `google/gemma-2-27b-it` | ? params | 0.1M |
...
| phi-2 | `microsoft/phi-2` | ? params | 1.1M |
...
| Gemma-4-31B-IT-NVFP4 | `nvidia/Gemma-4-31B-IT-NVFP4` | ? params | 0.9M |

### OpenAI (Open-weight)

| Model | HuggingFace ID | Size | Downloads |
|-------|----------------|------|-----------|
| gpt-oss-20b | `openai/gpt-oss-20b` | ? params | 6.1M |
...
---
*Last updated: 2026-04-15 | Open models auto-fetched from HuggingFace*
